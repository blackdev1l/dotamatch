...
class LobbiesControllerTest < ActionController::TestCase
  ...
  test "should create lobby" do
    assert_difference('Lobby.count') do
      post :create, lobby: { loc: @lobby.loc, name: @lobby.name, numPlayer: @lobby.numPlayer, skill: @lobby.skill }
    end
  ...
  test "should update lobby" do
    patch :update, id: @lobby, lobby: { loc: @lobby.loc, name: @lobby.name, numPlayer: @lobby.numPlayer, skill: @lobby.skill }
    assert_redirected_to lobby_path(assigns(:lobby))
  end
